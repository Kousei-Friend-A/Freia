...
from Flare_Robot import OWNER_ID, REDIS, dispatcher
...
from Flare_Robot.modules.helper_funcs.chat_status import callbacks_in_filters
...
WAIFUS_PIC = (
    ...
    "Ririna Sanada",
    "Misaki Takasaki",
    "Elizabeth Liones", "Kugisaki Nobara",
)
